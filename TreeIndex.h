...
// ------------------------------------------------------------------------------check
    ...
    std::unordered_set<int> greedyStep(query_nodes &queryNodes, int k);
    std::unordered_set<int> connectionStep(std::unordered_set<int> &H_min, query_nodes &queryNodes, int k);
